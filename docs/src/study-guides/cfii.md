...
<!--@include: ./docs/src/includes/metar-taf-examples/metar-1.md | shift:3-->
<!--@include: ./docs/src/includes/metar-taf-examples/metar-2.md | shift:3-->
<!--@include: ./docs/src/includes/metar-taf-examples/metar-3.md | shift:3-->
<!--@include: ./docs/src/includes/metar-taf-examples/metar-4.md | shift:3-->
<!--@include: ./docs/src/includes/metar-taf-examples/taf-1.md | shift:3-->
