...
<!--@include: ./docs/includes/preflight-information.md-->
...
<!--@include: ./docs/includes/equipment-requirements.md | shift:3-->
<!--@include: ./docs/includes/airworthiness-inop-equipment.md | shift:3-->
<!--@include: ./docs/includes/inspections-required.md | shift:3-->
...
<!--@include: ./docs/includes/ifr-alternates.md-->
...
<!--@include: ./docs/includes/departure-procedures.md | shift:3-->

## En Route

### Global Positioning System (GPS)

<!--@include: ./docs/includes/satellite-based-navigation.md | shift:3-->

### IFR En Route Charts

<!--@include: ./docs/includes/ifr-en-route.md | shift:3-->
...
<!--@include: ./docs/includes/ifr-equipment-failure.md | shift:3-->
...
<!--@include: ./docs/includes/arrival-procedures.md | shift:3-->

### Instrument Approach Procedures

<!--@include: ./docs/cfii/approaches/overview.md | shift:3-->
<!--@include: ./docs/cfii/approaches/precision.md | shift:3-->
<!--@include: ./docs/cfii/approaches/nonprecision.md | shift:3-->
